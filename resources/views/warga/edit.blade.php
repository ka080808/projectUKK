    ...
    <div class="container">
        ...
        <div class="sidebar">
            ...
            <nav>
                ...
                <a href="{{ route('warga.index') }}" class="active">👁️ Lihat Data Warga</a>
                    ...
                    <form action="{{ route('warga.update', $warga) }}" method="POST">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" id="nik" name="nik" maxlength="16" value="{{ old('nik', $warga->nik) }}" required>
                                @error('nik')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="no_kk" name="no_kk" maxlength="16" value="{{ old('no_kk', $warga->no_kk) }}" required>
                                @error('no_kk')
                                    <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group form-row full">
                            <div class="form-group">
                                ...
                                <textarea id="alamat" name="alamat" rows="3" required>{{ old('alamat', $warga->alamat) }}</textarea>
                                @error('alamat')
                                    <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="number" id="rt" name="rt" min="1" value="{{ old('rt', $warga->rt) }}" required>
                                @error('rt')
                                    <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="rw" name="rw" min="1" value="{{ old('rw', $warga->rw) }}" required>
                                @error('rw')
                                    <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="date" id="tanggal_lahir" name="tanggal_lahir" value="{{ old('tanggal_lahir', $warga->tanggal_lahir->format('Y-m-d')) }}" required>
                                @error('tanggal_lahir')
                                    <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" id="no_telp" name="no_telp" value="{{ old('no_telp', $warga->no_telp) }}">
                                @error('no_telp')
                                    <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group form-row full">
                            <div class="form-group">
                                ...
                                <select id="agama" name="agama" required>
                                    ...
                                    <option value="Kong Hu Cu" {{ old('agama', $warga->agama) == 'Kong Hu Cu' ? 'selected' : '' }}>Kong Hu Cu</option>
                                </select>
                                @error('agama')
                                    <div class="error">{{ $message }}</div>
                                @enderror
